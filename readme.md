# Spring PetClinic Sample Application [![Java CI with Maven](https://github.com/amakovet/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/amakovet/spring-petclinic/actions/workflows/maven.yml)
